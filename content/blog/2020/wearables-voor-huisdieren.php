...
<main class="h-container">
    <h1 class="blogpost__headline">Wearables voor huisdieren</h1>
    ...
    <div class="blogpost__content">
        ...
        <img src="<?php echo HTTP; ?>dist/gfx/images/2020/dog-clothed.jpg" alt="Een pup met kleding">
    ...
    <div class="references-container">
        ...
        <ol class="references__list">
            <li>Yasin Cotur, Michael Kasimatis, Matti Kaisti, Selin Olenik, Charis Georgiou, Firat Güder. <strong>Stretchable Composite Acoustic Transducer for Wearable Monitoring of Vital Signs</strong>. <em>Advanced Functional Materials</em>, 2020; 1910288 DOI: <a href="http://dx.doi.org/10.1002/adfm.201910288" rel="nofollow" target="_blank">10.1002/adfm.201910288</a>
            </li>
        </ol>
    </div>
</main>
